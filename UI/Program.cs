...
builder.Services.AddTransient<SecurityStaffConsumer>();
builder.Services.AddTransient<VisitorConsumer>();
builder.Services.AddTransient<VehicleConsumer>();
builder.Services.AddTransient<LogEntryConsumer>();
builder.Services.AddTransient<GateConsumer>();
builder.Services.AddTransient<CampusConsumer>();
builder.Services.AddTransient<InvolvedPartyConsumer>();
builder.Services.AddTransient<EmergencyEventConsumer>();
builder.Services.AddTransient<StaffManagerConsumer>();
